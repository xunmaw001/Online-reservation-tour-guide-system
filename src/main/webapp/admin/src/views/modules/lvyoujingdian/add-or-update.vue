	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230329/eff4ea96c952463cb46b9c79d043ce56.gif) fixed,#f6f6f6"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="城市" prop="chengshi">
					<el-input v-model="ruleForm.chengshi" placeholder="城市" clearable  :readonly="ro.chengshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="城市" prop="chengshi">
					<el-input v-model="ruleForm.chengshi" placeholder="城市" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="具体地址" prop="jutidizhi">
					<el-input v-model="ruleForm.jutidizhi" placeholder="具体地址" clearable  :readonly="ro.jutidizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="具体地址" prop="jutidizhi">
					<el-input v-model="ruleForm.jutidizhi" placeholder="具体地址" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.jingdianjieshao" label="景点介绍" prop="jingdianjieshao">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jingdianjieshao"></span>
                </el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.zhuyishixiang" label="注意事项" prop="zhuyishixiang">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.zhuyishixiang"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jingdianjieshao = this.ruleForm.jingdianjieshao.replace(reg,'../../../ssmfx998/upload');
        this.ruleForm.zhuyishixiang = this.ruleForm.zhuyishixiang.replace(reg,'../../../ssmfx998/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
