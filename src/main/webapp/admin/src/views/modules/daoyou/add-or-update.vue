	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230329/eff4ea96c952463cb46b9c79d043ce56.gif) fixed,#f6f6f6"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="导游等级" prop="daoyoudengji">
					<el-select :disabled="ro.daoyoudengji" v-model="ruleForm.daoyoudengji" placeholder="请选择导游等级" >
						<el-option
							v-for="(item,index) in daoyoudengjiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="导游等级" prop="daoyoudengji">
					<el-input v-model="ruleForm.daoyoudengji"
						placeholder="导游等级" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="导游语种" prop="daoyouyuzhong">
					<el-input v-model="ruleForm.daoyouyuzhong" placeholder="导游语种" clearable  :readonly="ro.daoyouyuzhong"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="导游语种" prop="daoyouyuzhong">
					<el-input v-model="ruleForm.daoyouyuzhong" placeholder="导游语种" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="旅行社" prop="lvxingshe">
					<el-input v-model="ruleForm.lvxingshe" placeholder="旅行社" clearable  :readonly="ro.lvxingshe"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="旅行社" prop="lvxingshe">
					<el-input v-model="ruleForm.lvxingshe" placeholder="旅行社" readonly></el-input>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='daoyoudengji'){
							this.ruleForm.daoyoudengji = obj[o];
							this.ro.daoyoudengji = true;
							continue;
						}
						if(o=='daoyouyuzhong'){
							this.ruleForm.daoyouyuzhong = obj[o];
							this.ro.daoyouyuzhong = true;
							continue;
						}
						if(o=='lvxingshe'){
							this.ruleForm.lvxingshe = obj[o];
							this.ro.lvxingshe = true;
							continue;
						}
						if(o=='lianxidianhua'){
