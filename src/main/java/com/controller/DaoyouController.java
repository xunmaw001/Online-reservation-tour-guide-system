...
public class DaoyouController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		DaoyouEntity u = daoyouService.selectOne(new EntityWrapper<DaoyouEntity>().eq("daoyouzhenghao", username));
    ...
    public R register(@RequestBody DaoyouEntity daoyou){
    	...
    	DaoyouEntity u = daoyouService.selectOne(new EntityWrapper<DaoyouEntity>().eq("daoyouzhenghao", daoyou.getDaoyouzhenghao()));
		if(u!=null) {
